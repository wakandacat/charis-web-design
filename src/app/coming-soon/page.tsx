...
export default function ComingSoon() {
  return (
    <div className="relative overflow-hidden bg-(--charis-green-2) min-h-dvh">
      <div className="pointer-events-none fixed bottom-0 h-dvh w-full">
        <div className="relative mx-auto flex h-full w-full max-w-7xl justify-center px-6 md:justify-end overflow-hidden">
          <Image
            src={flowerDecor}
            alt="Background decorative flower"
            className="h-full w-auto max-w-none object-contain object-bottom opacity-50 lg:opacity-100 transition-opacity duration-1000 ease-in-out"
            priority
          />
        </div>
      </div>
        ...
        <div className="relative mx-auto w-full max-w-7xl px-6 flex flex-row justify-between items-center">
          ...
          <div className="flex flex-row items-center">
            <Image
              ...
              className="self-stretch h-auto w-auto object-contain"
              width={100}
              height={100}
              priority
            />
